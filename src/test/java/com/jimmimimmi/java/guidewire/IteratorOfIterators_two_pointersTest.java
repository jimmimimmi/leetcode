...
public class IteratorOfIterators_two_pointersTest extends TestCase {
    public void testNullSubArrays() {
        var strings = new String[2][];

        var iteratorOfIterators = new IteratorOfIterators_two_pointers<>(strings);
    ...
    public void testNull() {
        var iteratorOfIterators = new IteratorOfIterators_two_pointers<>(null);
        assertFalse(iteratorOfIterators.hasNext());
        assertNull(iteratorOfIterators.next());
    }
